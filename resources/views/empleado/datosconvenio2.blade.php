...
<div class="container">
    <article class="container col-12 mx-auto p-0">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <label for="monto" class="form-label"><b>TIPO DE RENDICIÓN</b></label>
                    <input type="text" step=".01" class="form-control" id="monto" name="monto" min="0" value="{{ $registro->tipo_rendicion }}"  readonly required>
                </div>    
            </div> 	
...
$(document).ready(function() {
  ...
  var id, opcion, titulo;
        ...
        "ajax":{            
                        ...
                        "url": "{{route('empleado.datosdelconvenio2')}}", 
